...
function login(e) {
    ...
    try {
        ...
        var found = null;
        for (var i = 0; i < users.length; i++) {
            if (users[i].phone === phone && simpleDecode(users[i].password) === password) {
                found = users[i];
                break;
            }
        }
...
function showCompTab(tab) {
    ...
    if (tab === 'products') {
        ...
        if (list.length === 0) {
            content.innerHTML = '<p style="color:#666;">No products. <a href="#" onclick="showScreen(\'addProduct\')" style="color:#006400;">Add your first product</a></p>';
        } else {
            var h = '';
        ...
        if (list.length === 0) {
            content.innerHTML = '<p style="color:#666;">No orders yet.</p>';
        } else {
            var h = '';
            for (var i = 0; i < list.length; i++) {
                var o = list[i];
